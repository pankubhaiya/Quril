  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-row">
          <div>
            <label htmlFor="residentialAddress">Street 1 <span style={{color:"red"}}>*</span></label>
            <input
              type="text"
          ...
          <div>
            <label htmlFor="residentialAddress2">Street 2 <span style={{color:"red"}}>*</span></label>
            <input
              type="text"
        ...
        <div>
          <div className="uplodeform">
            ...
            <div>
              <label htmlFor="fileType">fileType <span style={{color:"red"}}>*</span></label>
              <select
                id="fileType"
                name="fileType"
            ...
            <div>
              <span  className="btn" type="button" onClick={addDocumentField}>
                <FaPlusSquare />
              </span>
            </div>
          </div>
          {formData.documents.slice(1).map((document, index) => (
            <div key={index} className="uplodeform">
              ...
              <div>
                <label htmlFor="fileName">fileType <span style={{color:"red"}}>*</span></label>
                <select
                  name="fileType"
              ...
              <div>
                <div className="upload-form">
                  <label htmlFor="fileName">Upload Document <span style={{color:"red"}}>*</span></label>
                  <label className="file-label">
                    <HiMiniArrowUpTray />
                    <input
